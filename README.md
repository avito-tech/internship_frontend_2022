...
## Разбор тествого задания
Пример решения тестового задания можно найти в папке `SolutionExample`. Решение представленно на основного одного из решенных тестовых заданий

Решение состоит из двух частей. В первой реализована клиентская часть вместе с опицональными заданиями. Вторая состоит из серверной части. Каждая часть содержит свой `README.md` по запуску
